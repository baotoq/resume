  ...
  return (
    <Section title="Professional Summary" icon={<UserOutlined />}>
      <div className="relative p-6 bg-[var(--muted)] rounded-2xl border border-[var(--border)]">
        <div
          className="absolute top-3 left-4 text-6xl text-[var(--accent)]/20 font-serif leading-none select-none"
          aria-hidden="true"
        >
          "
        </div>
        ...
        <div
          className="absolute bottom-1 right-4 text-6xl text-[var(--accent)]/20 font-serif leading-none rotate-180 select-none"
          aria-hidden="true"
        >
          "
        </div>

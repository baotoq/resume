...
export const metadata: Metadata = {
	...
	description:
		"Experienced Software Engineer with 7+ years of proven expertise in designing and building scalable, high-performance web applications. Specializing in .NET Core, Golang, Kubernetes, and cloud infrastructure.",
	keywords: [
		"software engineer",
